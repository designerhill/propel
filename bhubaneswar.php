...
session_start();
error_reporting(0);
$query2="select * from property where city='Bhubaneswar' and isapproved=1 limit 0,4";
$result2=mysqli_query($con,$query2) or die(mysqli_error($con));

$query1="select * from property where city='Bhubaneswar' and isapproved=1";
...
<head>
    ...
    <title>Apartments in Bhubaneswar I Buy, Sell, or Rent Properties</title>
    <meta name="description"
        content="Explore top apartments in Bhubaneswar for sale and rent. Discover the perfect property in the city with expert assistance.">
                            ...
                            <ul class="accordion-box">
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        ...
                                        <h5>Discover Your Dream Property in Bhubaneswar</h5>
                                    </div>
                                    <div class="acc-content current">
                                        <div class="content-box">
                                            <p>Looking to buy or rent in Bhubaneswar? We have a range of homes, from
                                                affordable apartments to luxurious properties, perfect for every need.
                                                Bhubaneswar is a city full of culture and growth, and we’re here to help
                                                you find the best place to live. </p>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>Why Bhubaneswar?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p>Known as the Temple City, Bhubaneswar offers a unique blend of rich
                                                history and modern living. With great educational institutions, a
                                                booming economy, and top-tier amenities, Bhubaneswar is an ideal place
                                                to call home.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>What kinds of properties do you have in Bhubaneswar?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p>From affordable apartments to upscale homes, we offer a range of
                                                properties to fit your needs in Bhubaneswar. You’ll find both short-term
                                                and long-term rental options as well as properties for sale.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>How do I know the prices are fair in Bhubaneswar?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p>We offer transparent pricing for all our properties, with no hidden
                                                costs. You’ll always get the best deals, backed by trusted partnerships.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>Can I visit a property before making a decision?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p>Yes, we encourage you to visit any property you’re interested in. Just
                                                get in touch with us, and we’ll arrange a tour at your convenience.</p>
                                        </div>
                                    </div>
                                </li>

                                <h4>Explore properties in Bhubaneswar with us – your perfect home is just a click away!
                                </h4>
                                <br></br>
                            </ul>
                        </div>
