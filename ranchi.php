...
session_start();
error_reporting(0);
$query2="select * from property where city='Ranchi' and isapproved=1 limit 0,4";
$result2=mysqli_query($con,$query2) or die(mysqli_error($con));

$query1="select * from property where city='Ranchi' and isapproved=1";
...
<head>
    ...
    <title>Apartments in Ranchi I Buy, sell, or Rent Properties</title>
    <meta name="description"
        content="Discover the best apartments in Ranchi for sale and rent. Explore premium listings and find your ideal property with expert support and guidance.">
                                            ...
                                            <div class="inner-box">
                                                ...
                                                <div class="lower-content">
                                                    ...
                                                    <ul class="more-details clearfix">
                                                        <li><i class="icon-14"></i><?php echo $row1['bedroom'];?>
                                                            Beds
                                                        </li>
                                                        <li><i class="icon-15"></i><?php echo $row1['bathroom'];?>
                                                            Baths
                                                        </li>
                                                        <li><i
                            ...
                            <ul class="accordion-box">
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        ...
                                        <h5>Find Your Perfect Home in Ranchi</h5>
                                    </div>
                                    <div class="acc-content current">
                                        <div class="content-box">
                                            <p> Looking for a property in Ranchi? Whether you’re buying or renting,
                                                we’ve got a variety of homes that fit every budget and lifestyle. From
                                                affordable flats to luxurious properties, Ranchi has something for
                                                everyone. Browse through our trusted listings, and we’ll help you find
                                                the ideal place to call home.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p> Ranchi offers a unique mix of nature, modern living, and growth
                                                opportunities. With its peaceful surroundings and developing
                                                infrastructure, it’s an excellent place to invest or settle down.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>What types of properties are available in Ranchi?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p>We offer a wide variety of properties in Ranchi, including affordable
                                                flats, mid-range homes, and luxury properties. Whatever your budget or
                                                style, we’ve got options for you!</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>How can I find trusted property deals in Ranchi?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p>All our listings are verified to ensure you get the best deals at
                                                competitive prices. We partner with reliable sellers to bring you
                                                properties you can trust.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                        <h5>Can I schedule a property tour in Ranchi?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content-box">
                                            <p> Absolutely! Just let us know which property you’re interested in, and
                                                we’ll arrange a viewing that suits your schedule.</p>
                                        </div>
                                    </div>
                                </li>

                                <h4>Start your property search in Ranchi today – we’ll help you find the perfect fit!
                                </h4>
                                <br></br>
                            </ul>
                        </div>
