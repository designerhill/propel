...
$query1="select * from property where stype='Buy' and isapproved=1";
...
$query1 = "SELECT * FROM property WHERE stype='Buy' and isapproved = 1 LIMIT 0,10";
$result1 = mysqli_query($con, $query1) or die(mysqli_error($con));
...
<head>
    ...
    <title>Buy Apartment I Explore Properties for Sale</title>
    <meta name="description"
        content="Find your dream apartment with the top listing for property purchases. Explore premium properties for sale and make your investment in the perfect home today">
...
?>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current"><a
                                                href="buy-flats-apartments-properties-near-you.php"><span>Buy</span></a>
                                        </li>
                                        <li><a
        ...
        <section class="page-title-two bg-color-1 centred">
            ...
            <div class="auto-container">
                <div class="content-box clearfix">
                    ...
                    <p class="mt-3" style="font-size:16px;">Experts in affordable and luxurious properties across your
                        city⁠—Find your dream home at the best price.<br> Explore now and compare deals you can trust.
                    </p>
                </div>
            </div>
        </section>
  ...
  padding: 0px 20px;" name="keyword" value="<?php echo $keyword;?>" placeholder="Keyword">
        ...
        function loadProperties(reset = false) {
            if (isLoading) return; // If already loading, stop

            if (reset) {
                page = 1; // Reset to the first page
                $('.deals-list-content').empty(); // Clear existing results
            }
        ...
        // Scroll event to load more properties when near the footer
