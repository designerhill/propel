...
if(isset($_POST['add']))
{
	...
	$sql1 = "UPDATE blog SET pimage='{$aimage}' WHERE pid = {$pid}";
	$result1=mysqli_query($con,$sql1);
	}
	
    $sql = "UPDATE blog SET title= '{$title}', pcontent= '{$content}' ,meta_description='$description', meta_title='$meta_title',meta_keyword='$keyword', slug='$slug' WHERE pid = {$pid}";
	...
	if($result == true)
	{
		...
		$msg="<p class='alert alert-warning'>Blog Not Updated</p>";
		header("Location:blogview.php?msg=$msg");
	}
}
?>
                ...
                <div class="card">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <?php
									...
									$pid=$_REQUEST['id'];
									$query=mysqli_query($con,"select * from blog where pid='$pid'");
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" name="keyword" required
                                                placeholder="Enter Meta Keyword"><?php echo $row['meta_keyword']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" name="description" required
                                                placeholder="Enter Meta Description"><?php echo $row['meta_description']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <img src="blog/<?php echo $row['pimage'];?>" alt="pimage" height="150"
                                                width="180">
                                        </div>
                                    </div>
