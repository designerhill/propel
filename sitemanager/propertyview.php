                ...
                <div class="card property-table-wrapper">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="propertyTable" class="table table-striped table-hover dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Title</th>
                                        <th>Type</th>
                                ...
                                <?php
                                                 ...
                                                 {
                                                     $sql = "select * from property where city='$city'";
													$query=mysqli_query($con,$sql);
                                                 }
...
$(document).ready(function() {
    $('#propertyTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No properties found in the database"
        },
