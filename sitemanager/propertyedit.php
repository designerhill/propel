...
<!-- Page specific modern form styles -->
<link href="css/form-custom.css" rel="stylesheet">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-banner">
                    ...
                    <p>Update listing information, pricing, media, and amenities. Make sure to save your changes.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card form-card">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <h5 class="card-title section-title">Property Detail</h5>
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" name="content" rows="10" id="summernote"
                                                cols="30"><?php echo $row['pcontent']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="projectId"
                                                value="<?php echo $row['projectId']; ?>" placeholder="Enter ProjectId">
                            ...
                            <h4 class="card-title section-title">SEO Data</h4>
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control"
                                                value="<?php echo $row['meta_title']; ?>" name="meta_title"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" name="keyword"
                                                placeholder="Enter Meta Keyword"><?php echo $row['keyword'];?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" name="description"
                                                placeholder="Enter Meta Description"><?php echo $row['description']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h4 class="card-title section-title">Price</h4>
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="maintenance"
                                                value="<?php echo $row['maintenance']; ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="annualduespayable"
                                                value="<?php echo $row['annualduespayable'];?>" aplaceholder=" Enter
                                                    Annual Dues Payable">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h4 class="card-title section-title">Location</h4>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="sublocation"
                                                value="<?php echo $row['sublocation'];?>"
                            ...
                            <h4 class="card-title section-title">Flooring</h4>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group row">
                            ...
                            <h4 class="card-title section-title">Area Details</h4>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="builtuparea"
                                                value="<?php echo $row['builtuparea'];?>"
                            ...
                            <h4 class="card-title section-title">Agent Details</h4>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control" name="agentname">
                                                <option value="<?php echo $row['agentname']; ?>">
                                                    <?php echo $row['agentname']; ?></option>
                                                <?php
                            ...
                            <h4 class="card-title section-title">ROI</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="rentalyield"
                                                value="<?php echo $row['rentalyield'];?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" class="form-control" name="propertyappretiation"
                                                value="<?php echo $row['propertyappretiation'];?>"
                                                placeholder="Enter Annual Property Appriciation">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h4 class="card-title section-title">Details</h4>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="date" class="form-control" name="posessiondate"
                                                value="<?php echo $row['posessiondate']; ?>"
                            ...
                            <h4 class="card-title section-title">Image & Status</h4>
                            <div class="row">
                                <div class="col-xl-6">
                            ...
                            <h4 class="card-title section-title">Map & Video</h4>
                            <div class="row">
                                <div class="col-xl-6">
                            ...
                            <h4 class="card-title section-title">Amenities</h4>
                            <div class="row">

                                <table class="amenities-table" style="font-size:15px;" align="center">
                                    <tr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label"><b>Is Featured?</b></label>
                                        <div class="col-lg-8">
                                            <select class="form-control" name="isFeatured">
                                                <?php foreach ($options as $option): ?>
                                                <option value="<?php echo $option['value']; ?>"
                                                    <?php if ($isFeatured == $option['value']) echo 'selected'; ?>>
                                                    <?php echo $option['text']; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                            ...
                            <div class="form-actions">
                                <a href="propertyview.php" class="btn btn-light">Cancel</a>
                                <input type="submit" value="Save Changes" class="btn btn-primary" name="add">
                            </div>
